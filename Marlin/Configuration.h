...
#define CUSTOM_MACHINE_NAME "СR-10 by Nick"
...
#define MPC_HEATER_POWER \
  { 40.0f }  // (W) Nominal heat cartridge powers.
...
#define NOZZLE_TO_PROBE_OFFSET \
  { -44, -9, 0 }  // (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
